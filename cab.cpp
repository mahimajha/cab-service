...
{ 
	...
	*/
	...
	{ 
		if (distanceEarth(lat2d, lon2d) <= 50.0000) // change circle radius
		{   cout<<name<<"is "<< distanceEarth(lat2d, lon2d)<<" km apart will take "<<" RS "<<distanceEarth(lat2d, lon2d)*5<<endl; 
